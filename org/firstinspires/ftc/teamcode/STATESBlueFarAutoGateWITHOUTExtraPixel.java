...
@Autonomous(name = "STATESBlueFarAutoGateWITHOUTExtraPixel (Blocks to Java)")
public class STATESBlueFarAutoGateWITHOUTExtraPixel extends LinearOpMode {
  ...
  private void runIntake(
      // TODO: Enter the type for argument named runIntakeInOut
      UNKNOWN_TYPE runIntakeInOut) {
    if (runIntakeInOut == "In") {
      intakeMotorAsDcMotor.setPower(1);
      intakeMotorAsDcMotor.setTargetPosition(2000);
    } else if (runIntakeInOut == "Out") {
      intakeMotorAsDcMotor.setPower(-1);
      intakeMotorAsDcMotor.setTargetPosition(-2000);
    } else if (runIntakeInOut == "Rest") {
  ...
  private void yield() {
    double rowNumber;
    double VSPower;
    // TODO: Enter the type for variable named passoffConveyor2
    UNKNOWN_TYPE passoffConveyor2;
   ...
   * Describe this function...
   */
  private void passoffConveyor(
      // TODO: Enter the type for argument named passoffConveyor2
      UNKNOWN_TYPE passoffConveyor2) {
    if (passoffConveyor2 == "In") {
