...
@Autonomous(name = "STATESRedFarAutoUnderTrusswExtraPixel (Blocks to Java)")
public class STATESRedFarAutoUnderTrusswExtraPixel extends LinearOpMode {
  ...
  public void runOpMode() {
    ...
    if (opModeIsActive()) {
      ...
      while (opModeIsActive()) {
        ...
        sleep(300);
        callRowHeight(1, 0.5);
        DriveFWDwRamp(36.5, 1, 0.035, 16.8);
        TurnRight(0, 0.5);
        ...
        if (detectedProp.equals("Right")) {
          ...
          sleep(100);
          // Process for drop on spikemark ends
          // Process for extra pixel
