...
@Autonomous(name = "STATESBlueCloseAutoNoExtraCycle (Blocks to Java)")
public class STATESBlueCloseAutoNoExtraCycle extends LinearOpMode {
   ...
   * Describe this function...
   */
  private void TurnW_ramp(double Angle, double Power) {
    double scaleFactor;
    ...
    if (opModeIsActive()) {
      ...
      while (opModeIsActive()) {
        ...
        if (detectedProp.equals("Left")) {
          ...
          pivotAngle(1);
          Drive_FWD(-3, 0.5);
          TurnW_ramp(-177.5, 0.5);
          DriveFWDwRamp(35, 1, 0.033, 16.62);
          setWristAngle(desiredWristAngle1);
          Drive_FWD(6, 0.3);
          StrafeRight(6.5, 0.35);
          TurnRight(0, 0.5);
          releasePixel(true, true, false);
          toggleServo.setPosition(scoringCentral);
          Drive_FWD(-2, 0.3);
  ...
  private void FourbarPosition(String IntakeRest12) {
    ...
    if (IntakeRest12.equals("Intake")) {
      ...
      intakePivotServoAsServo.setPosition(0.5);
